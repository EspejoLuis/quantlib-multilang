...
namespace QuantLibCSharp.Time
{
    public class Period
    {
        ...
        private static string LongFormatter(Period period)
        {
        ...
        private static string ShortFormatter(Period period)
        {
            int length = period.Length();
            return period.Units() switch
            {
        ...
        // Internal access for IO
        internal static string LongFormat(Period p) => LongFormatter(p);
        internal static string ShortFormat(Period p) => ShortFormatter(p);
    }
    public static class PeriodIO
    {
        public static string LongFormat(Period p) => Period.LongFormat(p);
        public static string ShortFormat(Period p) => Period.ShortFormat(p);
    }
}
